...
<img src="https://qiita-image-store.s3.ap-northeast-1.amazonaws.com/0/225786/b8fef7e8-3ae8-f8b3-e386-12e8385c7e1d.png" width="100">
...
postln リクエストにより、"Finished" という単語がpostされます)。 最終的に、最後に評価されたものの結果がデフォルトで post されます。この場合、たまたま　"Finished" という単語でした。
